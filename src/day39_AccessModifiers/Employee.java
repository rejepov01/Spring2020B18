...
public class Employee {
    ...
    public Employee(String name, String jobTitle,long id, double salary,char gender){
        this(name,jobTitle,id,salary); //  this.name = name; & this.jobTitle = jobTitle; & this.id = id; this.salary =salary;
        this.gender = gender;
    }
    ...
    public String toString(){
        return "Name: "+name+", id: "+id+", jobTitle: "+jobTitle+", salary: $"+salary+", gender: "+gender +", company name: "+companyName;
    }
