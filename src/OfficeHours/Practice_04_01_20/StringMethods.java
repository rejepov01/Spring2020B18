...
public class StringMethods {
    ...
    public static void main(String[] args) {
      ...
      //  System.out.println(ch2);
        ...
        // length returns total number of chars, int
        ...
        //substring(beginningIndex, ending index):  creates substring starting from beginning index till ending index (ending index is excluded)
